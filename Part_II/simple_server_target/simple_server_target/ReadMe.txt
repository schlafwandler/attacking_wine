========================================================================
    KONSOLENANWENDUNG: simple_server_target-Projektübersicht
========================================================================

Diese simple_server_target-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre simple_server_target-Anwendung besteht.


simple_server_target.vcxproj
...
simple_server_target.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen simple_server_target.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
